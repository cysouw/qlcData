...
# tokenize(test, profile = "test", file.out = "test")

# note that you can abbreviate this in R:
# tokenize_old(test, profile = "test", file.out = "test")
```
...
```{r, eval = FALSE}
tokenize(c("think", "thin", "both"), profile = "test", missing = "?")
```

```{r, echo = FALSE}
tokenize(c("think", "thin", "both"), profile = tmp, missing = "?")
```
